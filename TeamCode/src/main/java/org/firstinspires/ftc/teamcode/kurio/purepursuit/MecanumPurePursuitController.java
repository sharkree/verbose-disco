...
public class MecanumPurePursuitController {
    ...
    public static MecanumPowers goToPosition(Pose robotPose, Pose robotVelocity, WayPoint target, StopWayPoint finalTarget) {
        ...
        if (finalTarget == null || robotPose.distanceTo(finalTarget) > 18) {
        ...
        } else if (robotVelocity.distToOrigin() > MIN_SLIP_SPEED && robotPose.distanceTo(finalTarget) > UNDERSHOOT_DIST) { // If we're moving more than 8 in/sec and we're close to our target
